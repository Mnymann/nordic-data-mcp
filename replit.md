...
**Current shipped version: 1.5.0** (May 31, 2026). Live on NPM (`nordic-data-mcp@1.5.0`), Railway (`/healthz` reports 1.5.0), and the official MCP Registry (`io.github.Mnymann/nordic-data@1.5.0`). The `mcp-publisher` CLI binary lives at `/Users/martinnymann/mcp-registry/bin/mcp-publisher` on Martin's Mac.
